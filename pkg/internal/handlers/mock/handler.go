...
// Source: github.com/raba-jp/primus/pkg/internal/handlers (interfaces: CheckInstallHandler,InstallHandler,UninstallHandler,FileCopyHandler,FileMoveHandler,SymlinkHandler,HTTPRequestHandler,CommandHandler)
