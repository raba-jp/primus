...
// ArchPkgCheckInstallHandler is an autogenerated mock type for the ArchPkgCheckInstallHandler type
type ArchPkgCheckInstallHandler struct {
	mock.Mock
}
...
func (_m *ArchPkgCheckInstallHandler) ApplyCheckInstallExpectation(e ArchPkgCheckInstallHandlerCheckInstallExpectation) {
	var args []interface{}
...
func (_m *ArchPkgCheckInstallHandler) ApplyCheckInstallExpectations(expectations []ArchPkgCheckInstallHandlerCheckInstallExpectation) {
...
func (_m *ArchPkgCheckInstallHandler) CheckInstall(ctx context.Context, name string) bool {
