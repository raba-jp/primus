...
// MockStartServiceHandler is an autogenerated mock type for the StartServiceHandler type
...
func (_m *MockStartServiceHandler) ApplyStartServiceExpectation(e StartServiceHandlerStartServiceExpectation) {
	var args []interface{}
...
func (_m *MockStartServiceHandler) ApplyStartServiceExpectations(expectations []StartServiceHandlerStartServiceExpectation) {
...
func (_m *MockStartServiceHandler) StartService(ctx context.Context, dryrun bool, name string) error {
