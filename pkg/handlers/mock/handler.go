...
// Source: github.com/raba-jp/primus/pkg/handlers (interfaces: CheckInstallHandler,InstallHandler,UninstallHandler,FileCopyHandler,FileMoveHandler,SymlinkHandler,HTTPRequestHandler,CommandHandler,FishSetVariableHandler,FishSetPathHandler,CreateDirectoryHandler)
...
type MockCreateDirectoryHandler struct {
	ctrl     *gomock.Controller
	recorder *MockCreateDirectoryHandlerMockRecorder
}
...
type MockCreateDirectoryHandlerMockRecorder struct {
	mock *MockCreateDirectoryHandler
}
...
func NewMockCreateDirectoryHandler(ctrl *gomock.Controller) *MockCreateDirectoryHandler {
	mock := &MockCreateDirectoryHandler{ctrl: ctrl}
	mock.recorder = &MockCreateDirectoryHandlerMockRecorder{mock}
	return mock
}
...
func (m *MockCreateDirectoryHandler) CreateDirectory(arg0 context.Context, arg1 bool, arg2 *handlers.CreateDirectoryParams) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateDirectory", arg0, arg1, arg2)
	ret0, _ := ret[0].(error)
	return ret0
}
...
func (mr *MockCreateDirectoryHandlerMockRecorder) CreateDirectory(arg0, arg1, arg2 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateDirectory", reflect.TypeOf((*MockCreateDirectoryHandler)(nil).CreateDirectory), arg0, arg1, arg2)
}
