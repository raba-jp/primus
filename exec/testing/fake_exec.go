...
// SetEnv sets the SysProcAttr
func (fake *FakeCmd) SetSysProcAttr(proc *syscall.SysProcAttr) {
	fake.SysProcAttr = proc
}
...
func (fake *FakeCmd) Run() error {
	...
	if stdout != nil {
		_, _ = fake.Stdout.Write(stdout)
	}
	if stderr != nil {
		_, _ = fake.Stderr.Write(stderr)
	}
	return err
}
